...
public class NowPlayingPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  private void attach(ActivityPluginBinding binding) {
    ...
    // Android 14+ requires explicit export flag for non-system broadcasts.
    // Use ContextCompat to stay backward-compatible with pre-Tiramisu.
    androidx.core.content.ContextCompat.registerReceiver(
        context, changeBroadcastReceiver, intentFilter,
